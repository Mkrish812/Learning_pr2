  ...
  return (
    <Element name="reviews" className="py-10">
      <div className="container">
        ...
        <div className="inner-y-white overflow-hidden">
          <div className="animate-scroll-review-x relative -z-30 flex items-center gap-10 px-5 py-4 lg:gap-10">
        ...
        <div className="inner-y-white overflow-hidden">
          <div className="animate-scroll-review-xrev relative -z-30 flex -translate-x-[100%] items-center gap-10 px-5 py-4 lg:gap-10">
            {testimonials.map((items) => (
              <div
                key={items.id}
                className="bg-secondary relative flex h-64 max-w-xs min-w-xs flex-col gap-5 rounded-xl px-10 py-5 shadow-xl md:h-60 md:max-w-md"
          ...
          <div className="flex flex-col gap-3 md:flex-row md:gap-7">
            <div className="flex flex-col">
              <p className="text-center text-6xl font-medium">
                {" "}
                <CountUp end={23} duration={2} enableScrollSpy scrollSpyOnce />
                K+
              </p>
            ...
            <div className="my-3 w-0.5 bg-gray-200"></div>
            <div className="flex flex-col">
              <p className="text-center text-6xl font-medium">
                {" "}
            ...
            <div className="flex flex-col">
              <p className="text-center text-6xl font-medium">
                {" "}
                <CountUp end={500} duration={5} enableScrollSpy scrollSpyOnce />
                M+
              </p>
              <p className="text-center text-sm text-gray-500 md:text-lg">
                Happy Users
